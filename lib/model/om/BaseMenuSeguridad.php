...
/**
 * Base class that represents a row from the 'menu_seguridad' table.
 *
 *
 *
 ...
 */
abstract class BaseMenuSeguridad extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'MenuSeguridadPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        MenuSeguridadPeer
     */
    ...
    /**
     * Initializes internal state of BaseMenuSeguridad object.
     * @see        applyDefaults()
     */
     ...
     * @return MenuSeguridad The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = MenuSeguridadPeer::ID;
        }
    ...
    public function setDescripcion($v)
    {
        ...
        if ($this->descripcion !== $v) {
            $this->descripcion = $v;
            $this->modifiedColumns[] = MenuSeguridadPeer::DESCRIPCION;
        }
    ...
    public function setCredencial($v)
    {
        ...
        if ($this->credencial !== $v) {
            $this->credencial = $v;
            $this->modifiedColumns[] = MenuSeguridadPeer::CREDENCIAL;
        }
    ...
    public function setModulo($v)
    {
        ...
        if ($this->modulo !== $v) {
            $this->modulo = $v;
            $this->modifiedColumns[] = MenuSeguridadPeer::MODULO;
        }
    ...
    public function setIcono($v)
    {
        ...
        if ($this->icono !== $v) {
            $this->icono = $v;
            $this->modifiedColumns[] = MenuSeguridadPeer::ICONO;
        }
    ...
    public function setAccion($v)
    {
        ...
        if ($this->accion !== $v) {
            $this->accion = $v;
            $this->modifiedColumns[] = MenuSeguridadPeer::ACCION;
        }
    ...
    public function setSuperior($v)
    {
        ...
        if ($this->superior !== $v) {
            $this->superior = $v;
            $this->modifiedColumns[] = MenuSeguridadPeer::SUPERIOR;
        }
    ...
    public function setOrden($v)
    {
        ...
        if ($this->orden !== $v) {
            $this->orden = $v;
            $this->modifiedColumns[] = MenuSeguridadPeer::ORDEN;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->credencial = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->modulo = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->icono = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->accion = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->superior = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
            ...
            return $startcol + 8; // 8 = MenuSeguridadPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating MenuSeguridad object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = MenuSeguridadPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = MenuSeguridadQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseMenuSeguridad:delete:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseMenuSeguridad:delete:post') as $callable)
                {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseMenuSeguridad:save:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseMenuSeguridad:save:post') as $callable)
                {
                  call_user_func($callable, $this, $con, $affectedRows);
                }

                MenuSeguridadPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MenuSeguridadPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(MenuSeguridadPeer::DESCRIPCION)) {
            $modifiedColumns[':p' . $index++]  = '`DESCRIPCION`';
        }
        if ($this->isColumnModified(MenuSeguridadPeer::CREDENCIAL)) {
            $modifiedColumns[':p' . $index++]  = '`CREDENCIAL`';
        }
        if ($this->isColumnModified(MenuSeguridadPeer::MODULO)) {
            $modifiedColumns[':p' . $index++]  = '`MODULO`';
        }
        if ($this->isColumnModified(MenuSeguridadPeer::ICONO)) {
            $modifiedColumns[':p' . $index++]  = '`ICONO`';
        }
        if ($this->isColumnModified(MenuSeguridadPeer::ACCION)) {
            $modifiedColumns[':p' . $index++]  = '`ACCION`';
        }
        if ($this->isColumnModified(MenuSeguridadPeer::SUPERIOR)) {
            $modifiedColumns[':p' . $index++]  = '`SUPERIOR`';
        }
        if ($this->isColumnModified(MenuSeguridadPeer::ORDEN)) {
            $modifiedColumns[':p' . $index++]  = '`ORDEN`';
        }

        $sql = sprintf(
            'INSERT INTO `menu_seguridad` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`DESCRIPCION`':
                        ...
                        break;
                    case '`CREDENCIAL`':
                        $stmt->bindValue($identifier, $this->credencial, PDO::PARAM_STR);
                        break;
                    case '`MODULO`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = MenuSeguridadPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = MenuSeguridadPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['MenuSeguridad'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MenuSeguridad'][$this->getPrimaryKey()] = true;
        $keys = MenuSeguridadPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getDescripcion(),
            $keys[2] => $this->getCredencial(),
            $keys[3] => $this->getModulo(),
            $keys[4] => $this->getIcono(),
            $keys[5] => $this->getAccion(),
            $keys[6] => $this->getSuperior(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setIcono($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setAccion($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setSuperior($arr[$keys[6]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MenuSeguridadPeer::ID)) $criteria->add(MenuSeguridadPeer::ID, $this->id);
        if ($this->isColumnModified(MenuSeguridadPeer::DESCRIPCION)) $criteria->add(MenuSeguridadPeer::DESCRIPCION, $this->descripcion);
        if ($this->isColumnModified(MenuSeguridadPeer::CREDENCIAL)) $criteria->add(MenuSeguridadPeer::CREDENCIAL, $this->credencial);
        if ($this->isColumnModified(MenuSeguridadPeer::MODULO)) $criteria->add(MenuSeguridadPeer::MODULO, $this->modulo);
        if ($this->isColumnModified(MenuSeguridadPeer::ICONO)) $criteria->add(MenuSeguridadPeer::ICONO, $this->icono);
        if ($this->isColumnModified(MenuSeguridadPeer::ACCION)) $criteria->add(MenuSeguridadPeer::ACCION, $this->accion);
        if ($this->isColumnModified(MenuSeguridadPeer::SUPERIOR)) $criteria->add(MenuSeguridadPeer::SUPERIOR, $this->superior);
        if ($this->isColumnModified(MenuSeguridadPeer::ORDEN)) $criteria->add(MenuSeguridadPeer::ORDEN, $this->orden);
    ...
    {
        $criteria = new Criteria(MenuSeguridadPeer::DATABASE_NAME);
        $criteria->add(MenuSeguridadPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of MenuSeguridad (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setCredencial($this->getCredencial());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return MenuSeguridad Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return MenuSeguridadPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new MenuSeguridadPeer();
        }
     ...
     * If this MenuSeguridad is new, it will return
    ...
    public function setPerfilMenus(PropelCollection $perfilMenus, PropelPDO $con = null)
    {
        ...
        foreach ($this->perfilMenusScheduledForDeletion as $perfilMenuRemoved) {
            $perfilMenuRemoved->setMenuSeguridad(null);
        }
    ...
    protected function doAddPerfilMenu($perfilMenu)
    {
        ...
        $perfilMenu->setMenuSeguridad($this);
    }
    ...
    public function removePerfilMenu($perfilMenu)
    {
        if ($this->getPerfilMenus()->contains($perfilMenu)) {
            ...
            $perfilMenu->setMenuSeguridad(null);
        }
    }
     ...
     * Otherwise if this MenuSeguridad is new, it will return
     * an empty collection; or if this MenuSeguridad has previously
     * been saved, it will retrieve related PerfilMenus from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in MenuSeguridad.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseMenuSeguridad:' . $name))
        {
