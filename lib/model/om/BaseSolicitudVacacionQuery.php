...
abstract class BaseSolicitudVacacionQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `USUARIO_ID`, `FECHA_INICIO`, `FECHA_FIN`, `DIA`, `MOTIVO`, `OBSERVACIONES`, `USUARIO_MODERO`, `ESTADO`, `COMENTARIO_MODERO`, `CREATED_AT`, `UPDATED_AT` FROM `solicitud_vacacion` WHERE `ID` = :p0';
        try {
