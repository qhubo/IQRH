 ...
 * @method SolicitudVacacionQuery orderByEnviadoCorreo($order = Criteria::ASC) Order by the enviado_correo column
 *
 ...
 * @method SolicitudVacacionQuery groupByEnviadoCorreo() Group by the enviado_correo column
 *
 ...
 * @method SolicitudVacacion findOneByEnviadoCorreo(boolean $enviado_correo) Return the first SolicitudVacacion filtered by the enviado_correo column
 *
 ...
 * @method array findByEnviadoCorreo(boolean $enviado_correo) Return SolicitudVacacion objects filtered by the enviado_correo column
 *
...
abstract class BaseSolicitudVacacionQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `USUARIO_ID`, `FECHA_INICIO`, `FECHA_FIN`, `DIA`, `MOTIVO`, `OBSERVACIONES`, `USUARIO_MODERO`, `ESTADO`, `COMENTARIO_MODERO`, `CREATED_AT`, `UPDATED_AT`, `JEFE`, `ARCHIVO_UNO`, `ARCHIVO_DOS`, `ENVIADO_CORREO` FROM `solicitud_vacacion` WHERE `ID` = :p0';
        try {
    ...
    public function filterByEnviadoCorreo($enviadoCorreo = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SolicitudVacacionPeer::ENVIADO_CORREO, $enviadoCorreo, $comparison);
    }
