...
abstract class BaseReciboEncabezadoPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'PlanillaResumenId', 'Empleado', 'EmpleadoProyectoId', 'SueldoBase', 'BonificacionBase', 'DiasAusencias', 'DiasSuspendido', 'Septimos', 'TotalDescuentos', 'TotalIngresos', 'TotalExtras', 'TotalSueldoLiquido', 'Alta', 'Baja', 'Codigo', 'Puesto', 'Departamento', 'DiasBase', 'Bloque', 'Inicio', 'Fin', 'Numero', 'Laborados', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'planillaResumenId', 'empleado', 'empleadoProyectoId', 'sueldoBase', 'bonificacionBase', 'diasAusencias', 'diasSuspendido', 'septimos', 'totalDescuentos', 'totalIngresos', 'totalExtras', 'totalSueldoLiquido', 'alta', 'baja', 'codigo', 'puesto', 'departamento', 'diasBase', 'bloque', 'inicio', 'fin', 'numero', 'laborados', ),
        BasePeer::TYPE_COLNAME => array (ReciboEncabezadoPeer::ID, ReciboEncabezadoPeer::PLANILLA_RESUMEN_ID, ReciboEncabezadoPeer::EMPLEADO, ReciboEncabezadoPeer::EMPLEADO_PROYECTO_ID, ReciboEncabezadoPeer::SUELDO_BASE, ReciboEncabezadoPeer::BONIFICACION_BASE, ReciboEncabezadoPeer::DIAS_AUSENCIAS, ReciboEncabezadoPeer::DIAS_SUSPENDIDO, ReciboEncabezadoPeer::SEPTIMOS, ReciboEncabezadoPeer::TOTAL_DESCUENTOS, ReciboEncabezadoPeer::TOTAL_INGRESOS, ReciboEncabezadoPeer::TOTAL_EXTRAS, ReciboEncabezadoPeer::TOTAL_SUELDO_LIQUIDO, ReciboEncabezadoPeer::ALTA, ReciboEncabezadoPeer::BAJA, ReciboEncabezadoPeer::CODIGO, ReciboEncabezadoPeer::PUESTO, ReciboEncabezadoPeer::DEPARTAMENTO, ReciboEncabezadoPeer::DIAS_BASE, ReciboEncabezadoPeer::BLOQUE, ReciboEncabezadoPeer::INICIO, ReciboEncabezadoPeer::FIN, ReciboEncabezadoPeer::NUMERO, ReciboEncabezadoPeer::LABORADOS, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PLANILLA_RESUMEN_ID', 'EMPLEADO', 'EMPLEADO_PROYECTO_ID', 'SUELDO_BASE', 'BONIFICACION_BASE', 'DIAS_AUSENCIAS', 'DIAS_SUSPENDIDO', 'SEPTIMOS', 'TOTAL_DESCUENTOS', 'TOTAL_INGRESOS', 'TOTAL_EXTRAS', 'TOTAL_SUELDO_LIQUIDO', 'ALTA', 'BAJA', 'CODIGO', 'PUESTO', 'DEPARTAMENTO', 'DIAS_BASE', 'BLOQUE', 'INICIO', 'FIN', 'NUMERO', 'LABORADOS', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'Planilla_Resumen_id', 'empleado', 'empleado_proyecto_id', 'sueldo_base', 'bonificacion_base', 'dias_ausencias', 'dias_suspendido', 'septimos', 'total_descuentos', 'total_ingresos', 'total_extras', 'total_sueldo_liquido', 'alta', 'baja', 'codigo', 'puesto', 'departamento', 'dias_base', 'bloque', 'inicio', 'fin', 'numero', 'laborados', ),
