...
abstract class BaseParametroPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Codigo', 'Slogan', 'Logo', 'PuertoCorreo', 'SmtpCorreo', 'UsuarioCorreo', 'ClaveCorreo', 'BannerReporte', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'codigo', 'slogan', 'logo', 'puertoCorreo', 'smtpCorreo', 'usuarioCorreo', 'claveCorreo', 'bannerReporte', ),
        BasePeer::TYPE_COLNAME => array (ParametroPeer::ID, ParametroPeer::CODIGO, ParametroPeer::SLOGAN, ParametroPeer::LOGO, ParametroPeer::PUERTO_CORREO, ParametroPeer::SMTP_CORREO, ParametroPeer::USUARIO_CORREO, ParametroPeer::CLAVE_CORREO, ParametroPeer::BANNER_REPORTE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CODIGO', 'SLOGAN', 'LOGO', 'PUERTO_CORREO', 'SMTP_CORREO', 'USUARIO_CORREO', 'CLAVE_CORREO', 'BANNER_REPORTE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'codigo', 'slogan', 'logo', 'puerto_correo', 'smtp_correo', 'usuario_correo', 'clave_correo', 'banner_reporte', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Codigo' => 1, 'Slogan' => 2, 'Logo' => 3, 'PuertoCorreo' => 4, 'SmtpCorreo' => 5, 'UsuarioCorreo' => 6, 'ClaveCorreo' => 7, 'BannerReporte' => 8, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'codigo' => 1, 'slogan' => 2, 'logo' => 3, 'puertoCorreo' => 4, 'smtpCorreo' => 5, 'usuarioCorreo' => 6, 'claveCorreo' => 7, 'bannerReporte' => 8, ),
        BasePeer::TYPE_COLNAME => array (ParametroPeer::ID => 0, ParametroPeer::CODIGO => 1, ParametroPeer::SLOGAN => 2, ParametroPeer::LOGO => 3, ParametroPeer::PUERTO_CORREO => 4, ParametroPeer::SMTP_CORREO => 5, ParametroPeer::USUARIO_CORREO => 6, ParametroPeer::CLAVE_CORREO => 7, ParametroPeer::BANNER_REPORTE => 8, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CODIGO' => 1, 'SLOGAN' => 2, 'LOGO' => 3, 'PUERTO_CORREO' => 4, 'SMTP_CORREO' => 5, 'USUARIO_CORREO' => 6, 'CLAVE_CORREO' => 7, 'BANNER_REPORTE' => 8, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'codigo' => 1, 'slogan' => 2, 'logo' => 3, 'puerto_correo' => 4, 'smtp_correo' => 5, 'usuario_correo' => 6, 'clave_correo' => 7, 'banner_reporte' => 8, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
