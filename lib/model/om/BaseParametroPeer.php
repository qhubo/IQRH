...
abstract class BaseParametroPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Codigo', 'Slogan', 'Logo', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'codigo', 'slogan', 'logo', ),
        BasePeer::TYPE_COLNAME => array (ParametroPeer::ID, ParametroPeer::CODIGO, ParametroPeer::SLOGAN, ParametroPeer::LOGO, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CODIGO', 'SLOGAN', 'LOGO', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'codigo', 'slogan', 'logo', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Codigo' => 1, 'Slogan' => 2, 'Logo' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'codigo' => 1, 'slogan' => 2, 'logo' => 3, ),
        BasePeer::TYPE_COLNAME => array (ParametroPeer::ID => 0, ParametroPeer::CODIGO => 1, ParametroPeer::SLOGAN => 2, ParametroPeer::LOGO => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CODIGO' => 1, 'SLOGAN' => 2, 'LOGO' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'codigo' => 1, 'slogan' => 2, 'logo' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
