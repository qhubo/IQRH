...
abstract class BaseUsuario extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the codigo_proyecto field.
     * @var        string
     */
    protected $codigo_proyecto;

    /**
     * The value for the id_interno field.
     * @var        int
     */
    protected $id_interno;

    /**
     * The value for the id_interno_proyecto field.
     * @var        int
     */
    protected $id_interno_proyecto;
    ...
    /**
     * The value for the derecho_vaca field.
     * Note: this column has a database default value of: 15
     * @var        int
     */
    protected $derecho_vaca;
    ...
    /**
     * Get the [codigo_proyecto] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [id_interno] column value.
     *
     * @return int
     */
    ...
    /**
     * Get the [id_interno_proyecto] column value.
     *
     * @return int
     */
    public function getIdInternoProyecto()
    {
        return $this->id_interno_proyecto;
    }
    ...
    /**
     * Get the [derecho_vaca] column value.
     *
     * @return int
     */
    public function getDerechoVaca()
    {
        return $this->derecho_vaca;
    }
    ...
    /**
     * Set the value of [codigo_proyecto] column.
     *
     * @param string $v new value
     * @return Usuario The current object (for fluent API support)
     */
    public function setCodigoProyecto($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->codigo_proyecto !== $v) {
            $this->codigo_proyecto = $v;
            $this->modifiedColumns[] = UsuarioPeer::CODIGO_PROYECTO;
        }
    ...
    /**
     * Set the value of [id_interno] column.
     *
     * @param int $v new value
     * @return Usuario The current object (for fluent API support)
     */
    public function setIdInterno($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->id_interno !== $v) {
            $this->id_interno = $v;
            $this->modifiedColumns[] = UsuarioPeer::ID_INTERNO;
        }
    ...
    /**
     * Set the value of [id_interno_proyecto] column.
     *
     * @param int $v new value
     * @return Usuario The current object (for fluent API support)
     */
    public function setIdInternoProyecto($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->id_interno_proyecto !== $v) {
            $this->id_interno_proyecto = $v;
            $this->modifiedColumns[] = UsuarioPeer::ID_INTERNO_PROYECTO;
        }


        return $this;
    } // setIdInternoProyecto()
    ...
    public function setFechaBaja($v)
    {
        ...
        if ($this->fecha_baja !== null || $dt !== null) {
            $currentDateAsString = ($this->fecha_baja !== null && $tmpDt = new DateTime($this->fecha_baja)) ? $tmpDt->format('Y-m-d') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->fecha_baja = $newDateAsString;
                $this->modifiedColumns[] = UsuarioPeer::FECHA_BAJA;
            }
        } // if either are not null
    ...
    /**
     * Set the value of [derecho_vaca] column.
     *
     * @param int $v new value
     * @return Usuario The current object (for fluent API support)
     */
    public function setDerechoVaca($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->derecho_vaca !== $v) {
            $this->derecho_vaca = $v;
            $this->modifiedColumns[] = UsuarioPeer::DERECHO_VACA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->codigo_proyecto = ($row[$startcol + 35] !== null) ? (string) $row[$startcol + 35] : null;
            $this->id_interno = ($row[$startcol + 36] !== null) ? (int) $row[$startcol + 36] : null;
            $this->id_interno_proyecto = ($row[$startcol + 37] !== null) ? (int) $row[$startcol + 37] : null;
            $this->dpi = ($row[$startcol + 38] !== null) ? (string) $row[$startcol + 38] : null;
            $this->fecha_baja = ($row[$startcol + 39] !== null) ? (string) $row[$startcol + 39] : null;
            $this->derecho_vaca = ($row[$startcol + 40] !== null) ? (int) $row[$startcol + 40] : null;
            $this->resetModified();
            ...
            return $startcol + 41; // 41 = UsuarioPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UsuarioPeer::CODIGO_PROYECTO)) {
            $modifiedColumns[':p' . $index++]  = '`CODIGO_PROYECTO`';
        }
        if ($this->isColumnModified(UsuarioPeer::ID_INTERNO)) {
            $modifiedColumns[':p' . $index++]  = '`ID_INTERNO`';
        }
        if ($this->isColumnModified(UsuarioPeer::ID_INTERNO_PROYECTO)) {
            $modifiedColumns[':p' . $index++]  = '`ID_INTERNO_PROYECTO`';
        }
        if ($this->isColumnModified(UsuarioPeer::DPI)) {
            $modifiedColumns[':p' . $index++]  = '`DPI`';
        }
        if ($this->isColumnModified(UsuarioPeer::FECHA_BAJA)) {
            $modifiedColumns[':p' . $index++]  = '`FECHA_BAJA`';
        }
        if ($this->isColumnModified(UsuarioPeer::DERECHO_VACA)) {
            $modifiedColumns[':p' . $index++]  = '`DERECHO_VACA`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`CODIGO_PROYECTO`':
                        $stmt->bindValue($identifier, $this->codigo_proyecto, PDO::PARAM_STR);
                        break;
                    case '`ID_INTERNO`':
                        $stmt->bindValue($identifier, $this->id_interno, PDO::PARAM_INT);
                        break;
                    case '`ID_INTERNO_PROYECTO`':
                        $stmt->bindValue($identifier, $this->id_interno_proyecto, PDO::PARAM_INT);
                        break;
                    case '`DPI`':
                        $stmt->bindValue($identifier, $this->dpi, PDO::PARAM_STR);
                        break;
                    case '`FECHA_BAJA`':
                        $stmt->bindValue($identifier, $this->fecha_baja, PDO::PARAM_STR);
                        break;
                    case '`DERECHO_VACA`':
                        $stmt->bindValue($identifier, $this->derecho_vaca, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 34:
                ...
                break;
            case 35:
                return $this->getCodigoProyecto();
                break;
            case 36:
                return $this->getIdInterno();
                break;
            case 37:
                return $this->getIdInternoProyecto();
                break;
            case 38:
                return $this->getDpi();
                break;
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[35] => $this->getCodigoProyecto(),
            $keys[36] => $this->getIdInterno(),
            $keys[37] => $this->getIdInternoProyecto(),
            $keys[38] => $this->getDpi(),
            $keys[39] => $this->getFechaBaja(),
            $keys[40] => $this->getDerechoVaca(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 34:
                ...
                break;
            case 35:
                $this->setCodigoProyecto($value);
                break;
            case 36:
                $this->setIdInterno($value);
                break;
            case 37:
                $this->setIdInternoProyecto($value);
                break;
            case 38:
                $this->setDpi($value);
                break;
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[35], $arr)) $this->setCodigoProyecto($arr[$keys[35]]);
        if (array_key_exists($keys[36], $arr)) $this->setIdInterno($arr[$keys[36]]);
        if (array_key_exists($keys[37], $arr)) $this->setIdInternoProyecto($arr[$keys[37]]);
        if (array_key_exists($keys[38], $arr)) $this->setDpi($arr[$keys[38]]);
        if (array_key_exists($keys[39], $arr)) $this->setFechaBaja($arr[$keys[39]]);
        if (array_key_exists($keys[40], $arr)) $this->setDerechoVaca($arr[$keys[40]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsuarioPeer::CODIGO_PROYECTO)) $criteria->add(UsuarioPeer::CODIGO_PROYECTO, $this->codigo_proyecto);
        if ($this->isColumnModified(UsuarioPeer::ID_INTERNO)) $criteria->add(UsuarioPeer::ID_INTERNO, $this->id_interno);
        if ($this->isColumnModified(UsuarioPeer::ID_INTERNO_PROYECTO)) $criteria->add(UsuarioPeer::ID_INTERNO_PROYECTO, $this->id_interno_proyecto);
        if ($this->isColumnModified(UsuarioPeer::DPI)) $criteria->add(UsuarioPeer::DPI, $this->dpi);
        if ($this->isColumnModified(UsuarioPeer::FECHA_BAJA)) $criteria->add(UsuarioPeer::FECHA_BAJA, $this->fecha_baja);
        if ($this->isColumnModified(UsuarioPeer::DERECHO_VACA)) $criteria->add(UsuarioPeer::DERECHO_VACA, $this->derecho_vaca);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setCodigoProyecto($this->getCodigoProyecto());
        $copyObj->setIdInterno($this->getIdInterno());
        $copyObj->setIdInternoProyecto($this->getIdInternoProyecto());
        $copyObj->setDpi($this->getDpi());
        $copyObj->setFechaBaja($this->getFechaBaja());
        $copyObj->setDerechoVaca($this->getDerechoVaca());
    ...
    public function clear()
    {
        ...
        $this->id_interno_proyecto = null;
        $this->dpi = null;
        $this->fecha_baja = null;
        $this->derecho_vaca = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
