...
/**
 * Base class that represents a query for the 'usuario_perfil' table.
 *
 *
 *
 ...
 *
 * @method UsuarioPerfil findOneById(int $id) Return the first UsuarioPerfil filtered by the id column
...
abstract class BaseUsuarioPerfilQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'propel', $modelName = 'UsuarioPerfil', $modelAlias = null)
    {
