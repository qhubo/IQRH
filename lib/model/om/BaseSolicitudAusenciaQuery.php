 ...
 * @method SolicitudAusenciaQuery orderByEnviadoCorreo($order = Criteria::ASC) Order by the enviado_correo column
 *
 ...
 * @method SolicitudAusenciaQuery groupByEnviadoCorreo() Group by the enviado_correo column
 *
 ...
 * @method SolicitudAusencia findOneByEnviadoCorreo(boolean $enviado_correo) Return the first SolicitudAusencia filtered by the enviado_correo column
 *
 ...
 * @method array findByEnviadoCorreo(boolean $enviado_correo) Return SolicitudAusencia objects filtered by the enviado_correo column
 *
...
abstract class BaseSolicitudAusenciaQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `USUARIO_ID`, `FECHA`, `MOTIVO`, `OBSERVACIONES`, `ESTADO`, `CREATED_AT`, `UPDATED_AT`, `JEFE`, `USUARIO_MODERO`, `COMENTARIO_MODERO`, `ARCHIVO_UNO`, `ARCHIVO_DOS`, `FECHA_FIN`, `ENVIADO_CORREO` FROM `solicitud_ausencia` WHERE `ID` = :p0';
        try {
    ...
    public function filterByEnviadoCorreo($enviadoCorreo = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SolicitudAusenciaPeer::ENVIADO_CORREO, $enviadoCorreo, $comparison);
    }
