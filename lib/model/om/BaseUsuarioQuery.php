...
abstract class BaseUsuarioQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `CODIGO`, `USUARIO`, `CLAVE`, `CORREO`, `ESTADO`, `IMAGEN`, `ADMINISTRADOR`, `VALIDADO`, `ULTIMO_INGRESO`, `TEMA`, `FRASE`, `GENERO`, `FECHA_NACIMIENTO`, `NOMBRE_COMPLETO`, `EMPRESA`, `LOGO`, `ACTIVO`, `TIPO_USUARIO`, `OBSERVACIONES`, `PRIMER_NOMBRE`, `SEGUNDO_NOMBRE`, `PRIMER_APELLIDO`, `SEGUNDO_APELLIDO`, `PUESTO`, `DEPARTAMENTO`, `JEFE`, `FECHA_ALTA`, `SUELDO` FROM `usuario` WHERE `ID` = :p0';
        try {
