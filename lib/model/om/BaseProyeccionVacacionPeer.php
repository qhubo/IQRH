...
abstract class BaseProyeccionVacacionPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Usuario', 'FechaInicio', 'FechaFin', 'Periodo', 'DiaVacacion', 'Estatus', 'UsuarioCreo', 'FechaCrea', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'usuario', 'fechaInicio', 'fechaFin', 'periodo', 'diaVacacion', 'estatus', 'usuarioCreo', 'fechaCrea', ),
        BasePeer::TYPE_COLNAME => array (ProyeccionVacacionPeer::ID, ProyeccionVacacionPeer::USUARIO, ProyeccionVacacionPeer::FECHA_INICIO, ProyeccionVacacionPeer::FECHA_FIN, ProyeccionVacacionPeer::PERIODO, ProyeccionVacacionPeer::DIA_VACACION, ProyeccionVacacionPeer::ESTATUS, ProyeccionVacacionPeer::USUARIO_CREO, ProyeccionVacacionPeer::FECHA_CREA, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USUARIO', 'FECHA_INICIO', 'FECHA_FIN', 'PERIODO', 'DIA_VACACION', 'ESTATUS', 'USUARIO_CREO', 'FECHA_CREA', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'usuario', 'fecha_inicio', 'fecha_fin', 'periodo', 'dia_vacacion', 'estatus', 'usuario_creo', 'fecha_crea', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Usuario' => 1, 'FechaInicio' => 2, 'FechaFin' => 3, 'Periodo' => 4, 'DiaVacacion' => 5, 'Estatus' => 6, 'UsuarioCreo' => 7, 'FechaCrea' => 8, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'usuario' => 1, 'fechaInicio' => 2, 'fechaFin' => 3, 'periodo' => 4, 'diaVacacion' => 5, 'estatus' => 6, 'usuarioCreo' => 7, 'fechaCrea' => 8, ),
        BasePeer::TYPE_COLNAME => array (ProyeccionVacacionPeer::ID => 0, ProyeccionVacacionPeer::USUARIO => 1, ProyeccionVacacionPeer::FECHA_INICIO => 2, ProyeccionVacacionPeer::FECHA_FIN => 3, ProyeccionVacacionPeer::PERIODO => 4, ProyeccionVacacionPeer::DIA_VACACION => 5, ProyeccionVacacionPeer::ESTATUS => 6, ProyeccionVacacionPeer::USUARIO_CREO => 7, ProyeccionVacacionPeer::FECHA_CREA => 8, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USUARIO' => 1, 'FECHA_INICIO' => 2, 'FECHA_FIN' => 3, 'PERIODO' => 4, 'DIA_VACACION' => 5, 'ESTATUS' => 6, 'USUARIO_CREO' => 7, 'FECHA_CREA' => 8, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'usuario' => 1, 'fecha_inicio' => 2, 'fecha_fin' => 3, 'periodo' => 4, 'dia_vacacion' => 5, 'estatus' => 6, 'usuario_creo' => 7, 'fecha_crea' => 8, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
