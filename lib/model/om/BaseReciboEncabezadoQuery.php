...
abstract class BaseReciboEncabezadoQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `PLANILLA_RESUMEN_ID`, `EMPLEADO`, `EMPLEADO_PROYECTO_ID`, `SUELDO_BASE`, `BONIFICACION_BASE`, `DIAS_AUSENCIAS`, `DIAS_SUSPENDIDO`, `SEPTIMOS`, `TOTAL_DESCUENTOS`, `TOTAL_INGRESOS`, `TOTAL_EXTRAS`, `TOTAL_SUELDO_LIQUIDO`, `ALTA`, `BAJA`, `CODIGO`, `PUESTO`, `DEPARTAMENTO`, `DIAS_BASE`, `BLOQUE`, `INICIO`, `FIN`, `NUMERO`, `LABORADOS` FROM `recibo_encabezado` WHERE `ID` = :p0';
        try {
