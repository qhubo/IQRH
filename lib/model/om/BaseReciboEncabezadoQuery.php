 ...
 * @method ReciboEncabezadoQuery orderByEnviadoCorreo($order = Criteria::ASC) Order by the enviado_correo column
 *
 ...
 * @method ReciboEncabezadoQuery groupByEnviadoCorreo() Group by the enviado_correo column
 *
 ...
 * @method ReciboEncabezado findOneByEnviadoCorreo(boolean $enviado_correo) Return the first ReciboEncabezado filtered by the enviado_correo column
 *
 ...
 * @method array findByEnviadoCorreo(boolean $enviado_correo) Return ReciboEncabezado objects filtered by the enviado_correo column
 *
...
abstract class BaseReciboEncabezadoQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `PLANILLA_RESUMEN_ID`, `EMPLEADO`, `EMPLEADO_PROYECTO_ID`, `SUELDO_BASE`, `BONIFICACION_BASE`, `DIAS_AUSENCIAS`, `DIAS_SUSPENDIDO`, `SEPTIMOS`, `TOTAL_DESCUENTOS`, `TOTAL_INGRESOS`, `TOTAL_EXTRAS`, `TOTAL_SUELDO_LIQUIDO`, `ALTA`, `BAJA`, `CODIGO`, `PUESTO`, `DEPARTAMENTO`, `DIAS_BASE`, `BLOQUE`, `INICIO`, `FIN`, `NUMERO`, `LABORADOS`, `CABECERA_IN`, `ENVIADO_CORREO` FROM `recibo_encabezado` WHERE `ID` = :p0';
        try {
    ...
    public function filterByEnviadoCorreo($enviadoCorreo = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ReciboEncabezadoPeer::ENVIADO_CORREO, $enviadoCorreo, $comparison);
    }
