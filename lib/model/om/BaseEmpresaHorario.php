...
abstract class BaseEmpresaHorario extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the estricto field.
    ...
    /**
     * The value for the minuto_prorroga field.
     * Note: this column has a database default value of: 0
     * @var        int
     */
    protected $minuto_prorroga;

    /**
     * The value for the texto_uno field.
     * @var        string
     */
    protected $texto_uno;

    /**
     * The value for the texto_dos field.
     * @var        string
     */
    protected $texto_dos;

    /**
     * The value for the correo_notifica field.
     * @var        string
     */
    protected $correo_notifica;
    ...
    {
        $this->estricto = true;
        $this->minuto_prorroga = 0;
    }

    /**
     * Initializes internal state of BaseEmpresaHorario object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [minuto_prorroga] column value.
     *
     * @return int
     */
    public function getMinutoProrroga()
    {
        return $this->minuto_prorroga;
    }

    /**
     * Get the [texto_uno] column value.
     *
     * @return string
     */
    public function getTextoUno()
    {
        return $this->texto_uno;
    }

    /**
     * Get the [texto_dos] column value.
     *
     * @return string
     */
    public function getTextoDos()
    {
        return $this->texto_dos;
    }

    /**
     * Get the [correo_notifica] column value.
     *
     * @return string
     */
    public function getCorreoNotifica()
    {
        return $this->correo_notifica;
    }
    ...
    /**
     * Sets the value of the [estricto] column.
    ...
    public function setEstricto($v)
    {
        ...
        if ($this->estricto !== $v) {
            $this->estricto = $v;
            $this->modifiedColumns[] = EmpresaHorarioPeer::ESTRICTO;
        }
    ...
    /**
     * Set the value of [minuto_prorroga] column.
     *
     * @param int $v new value
     * @return EmpresaHorario The current object (for fluent API support)
     */
    public function setMinutoProrroga($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->minuto_prorroga !== $v) {
            $this->minuto_prorroga = $v;
            $this->modifiedColumns[] = EmpresaHorarioPeer::MINUTO_PRORROGA;
        }
    ...
    /**
     * Set the value of [texto_uno] column.
     *
     * @param string $v new value
     * @return EmpresaHorario The current object (for fluent API support)
     */
    public function setTextoUno($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->texto_uno !== $v) {
            $this->texto_uno = $v;
            $this->modifiedColumns[] = EmpresaHorarioPeer::TEXTO_UNO;
        }
    ...
    /**
     * Set the value of [texto_dos] column.
     *
     * @param string $v new value
     * @return EmpresaHorario The current object (for fluent API support)
     */
    public function setTextoDos($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->texto_dos !== $v) {
            $this->texto_dos = $v;
            $this->modifiedColumns[] = EmpresaHorarioPeer::TEXTO_DOS;
        }
    ...
    /**
     * Set the value of [correo_notifica] column.
     *
     * @param string $v new value
     * @return EmpresaHorario The current object (for fluent API support)
     */
    public function setCorreoNotifica($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->correo_notifica !== $v) {
            $this->correo_notifica = $v;
            $this->modifiedColumns[] = EmpresaHorarioPeer::CORREO_NOTIFICA;
        }
    ...
    {
            if ($this->estricto !== true) {
                return false;
            }

            if ($this->minuto_prorroga !== 0) {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->estricto = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
            $this->minuto_prorroga = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            $this->texto_uno = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->texto_dos = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->correo_notifica = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->resetModified();
            ...
            return $startcol + 11; // 11 = EmpresaHorarioPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EmpresaHorarioPeer::ESTRICTO)) {
            $modifiedColumns[':p' . $index++]  = '`ESTRICTO`';
        }
        if ($this->isColumnModified(EmpresaHorarioPeer::MINUTO_PRORROGA)) {
            $modifiedColumns[':p' . $index++]  = '`MINUTO_PRORROGA`';
        }
        if ($this->isColumnModified(EmpresaHorarioPeer::TEXTO_UNO)) {
            $modifiedColumns[':p' . $index++]  = '`TEXTO_UNO`';
        }
        if ($this->isColumnModified(EmpresaHorarioPeer::TEXTO_DOS)) {
            $modifiedColumns[':p' . $index++]  = '`TEXTO_DOS`';
        }
        if ($this->isColumnModified(EmpresaHorarioPeer::CORREO_NOTIFICA)) {
            $modifiedColumns[':p' . $index++]  = '`CORREO_NOTIFICA`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`HORA_FIN24`':
                        ...
                        break;
                    case '`ESTRICTO`':
                        $stmt->bindValue($identifier, (int) $this->estricto, PDO::PARAM_INT);
                        break;
                    case '`MINUTO_PRORROGA`':
                        $stmt->bindValue($identifier, $this->minuto_prorroga, PDO::PARAM_INT);
                        break;
                    case '`TEXTO_UNO`':
                        $stmt->bindValue($identifier, $this->texto_uno, PDO::PARAM_STR);
                        break;
                    case '`TEXTO_DOS`':
                        $stmt->bindValue($identifier, $this->texto_dos, PDO::PARAM_STR);
                        break;
                    case '`CORREO_NOTIFICA`':
                        $stmt->bindValue($identifier, $this->correo_notifica, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 5:
                ...
                break;
            case 6:
                return $this->getEstricto();
                break;
            case 7:
                return $this->getMinutoProrroga();
                break;
            case 8:
                return $this->getTextoUno();
                break;
            case 9:
                return $this->getTextoDos();
                break;
            case 10:
                return $this->getCorreoNotifica();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[6] => $this->getEstricto(),
            $keys[7] => $this->getMinutoProrroga(),
            $keys[8] => $this->getTextoUno(),
            $keys[9] => $this->getTextoDos(),
            $keys[10] => $this->getCorreoNotifica(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 5:
                ...
                break;
            case 6:
                $this->setEstricto($value);
                break;
            case 7:
                $this->setMinutoProrroga($value);
                break;
            case 8:
                $this->setTextoUno($value);
                break;
            case 9:
                $this->setTextoDos($value);
                break;
            case 10:
                $this->setCorreoNotifica($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) $this->setEstricto($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setMinutoProrroga($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setTextoUno($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setTextoDos($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setCorreoNotifica($arr[$keys[10]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EmpresaHorarioPeer::ESTRICTO)) $criteria->add(EmpresaHorarioPeer::ESTRICTO, $this->estricto);
        if ($this->isColumnModified(EmpresaHorarioPeer::MINUTO_PRORROGA)) $criteria->add(EmpresaHorarioPeer::MINUTO_PRORROGA, $this->minuto_prorroga);
        if ($this->isColumnModified(EmpresaHorarioPeer::TEXTO_UNO)) $criteria->add(EmpresaHorarioPeer::TEXTO_UNO, $this->texto_uno);
        if ($this->isColumnModified(EmpresaHorarioPeer::TEXTO_DOS)) $criteria->add(EmpresaHorarioPeer::TEXTO_DOS, $this->texto_dos);
        if ($this->isColumnModified(EmpresaHorarioPeer::CORREO_NOTIFICA)) $criteria->add(EmpresaHorarioPeer::CORREO_NOTIFICA, $this->correo_notifica);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setEstricto($this->getEstricto());
        $copyObj->setMinutoProrroga($this->getMinutoProrroga());
        $copyObj->setTextoUno($this->getTextoUno());
        $copyObj->setTextoDos($this->getTextoDos());
        $copyObj->setCorreoNotifica($this->getCorreoNotifica());
        if ($makeNew) {
            $copyObj->setNew(true);
    ...
    public function clear()
    {
        ...
        $this->estricto = null;
        $this->minuto_prorroga = null;
        $this->texto_uno = null;
        $this->texto_dos = null;
        $this->correo_notifica = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
