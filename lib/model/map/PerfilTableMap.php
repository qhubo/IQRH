...
class PerfilTableMap extends TableMap
{
    ...
    {
        $this->addRelation('UsuarioPerfil', 'UsuarioPerfil', RelationMap::ONE_TO_MANY, array('id' => 'perfil_id', ), null, null, 'UsuarioPerfils');
        $this->addRelation('PerfilMenu', 'PerfilMenu', RelationMap::ONE_TO_MANY, array('id' => 'perfil_id', ), null, null, 'PerfilMenus');
    } // buildRelations()
