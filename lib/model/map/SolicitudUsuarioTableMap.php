...
/**
 * This class defines the structure of the 'solicitud_usuario' table.
 *
 *
 ...
 */
class SolicitudUsuarioTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lib.model.map.SolicitudUsuarioTableMap';
    ...
    {
        // attributes
        $this->setName('solicitud_usuario');
        $this->setPhpName('SolicitudUsuario');
        $this->setClassname('SolicitudUsuario');
        ...
        $this->addForeignKey('CATALOGO_SOLICITUD_ID', 'CatalogoSolicitudId', 'INTEGER', 'catalogo_solicitud', 'ID', false, null, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('CatalogoSolicitud', 'CatalogoSolicitud', RelationMap::MANY_TO_ONE, array('catalogo_solicitud_id' => 'id', ), null, null);
    } // buildRelations()
