...
class UsuarioTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('TOKEN', 'Token', 'VARCHAR', false, 300, null);
        $this->addColumn('FECHA_REPORTE', 'FechaReporte', 'VARCHAR', false, 300, null);
        $this->addColumn('HORAS', 'Horas', 'DOUBLE', false, null, null);
        $this->addColumn('CODIGO_PROYECTO', 'CodigoProyecto', 'VARCHAR', false, 50, null);
        $this->addColumn('ID_INTERNO', 'IdInterno', 'INTEGER', false, null, null);
        $this->addColumn('ID_INTERNO_PROYECTO', 'IdInternoProyecto', 'INTEGER', false, null, null);
        $this->addColumn('DPI', 'Dpi', 'VARCHAR', false, 30, null);
        $this->addColumn('FECHA_BAJA', 'FechaBaja', 'DATE', false, null, null);
        $this->addColumn('DERECHO_VACA', 'DerechoVaca', 'INTEGER', false, null, 15);
        // validators
    } // initialize()
