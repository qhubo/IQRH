...
$pdf->SetAuthor('VIA');
$pdf->SetTitle('Nota Credito Electronica');
$pdf->SetSubject('Nota Credito');
$pdf->SetKeywords('Nota, Detalle, Cobro');
...
//$archivo='00100001030000000001_02_Firmado.xml';
...
$xml = simplexml_load_file("uploads/nce/".$archivo);
...
//    
//}
$antes ='/home/iqrhviasagt/public_html/uploads/nota/'.$archivo;
...
//print_r($DETALLEServicio['LineaDetalle']);
$rev =$DETALLEServicio['LineaDetalle'];
 $unalinea =FALSE; 
if (array_key_exists('Codigo', $rev)) {
     $unalinea =true;
 }
...
$InformacionReferencia = $xmlArr['InformacionReferencia']; // => Array
...
$Razon=$InformacionReferencia['Razon'];
...
<p style="text-align: center;"><span style="color: #000080;">Nota CR&Eacute;DITO</span><br /><span style="color: #000080;">NO. <span style="color: #ff0000;"><strong>' . $NumeroConsecutivo . '</strong></span></span></p>
...
<td style="width: 290px; height: 14px; text-align: left; vertical-align: top;border-bottom: 1px solid black">Observaci&oacute;n:&nbsp;&nbsp;<br><br> '.$Razon.'<br><br><br></td>
