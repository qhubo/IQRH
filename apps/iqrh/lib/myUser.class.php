...
class myUser extends sfBasicSecurityUser {
    ...
    public function HojaEncabezado($hoja, $titulo, $filtros, $rutaimagen = null) {
        ...
        if (!$rutaimagen) {
            $objDrawing->setPath('./images/avatar_small.png');
        } else {
            $objDrawing->setPath('./uploads/empresas/' . $rutaimagen);
//        $objDrawing->setPath('./uploads/empresas/2410a88f64983a2dd6133df7fad38afd1dda6688.png');
        }
        ...
        foreach ($filtros as $subtitulo) {
            ...
            $hoja->getStyle($inicio . $contador)->getFont()->setBold(true);
            $hoja->getStyle($inicio . $contador)->getFont()->setSize(9);
            ...
            $hoja->getStyle($centroM . $contador)->getFont()->setSize(9);
...
//$excel->getActiveSheet()->getStyle('C1')->getNumberFormat()->setFormatCode($textFormat);
            ...
            $hoja->getStyle($letra . $fila)->getFont()->setSize(9);
