...
<div class="portlet light">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject bold font-yellow-casablanca uppercase">#<?php echo $ausencia->getId(); ?>- Rechazar  </span>
           
             <span class="caption-subject bold font-yellow-casablanca uppercase">Solicitud </span>
    ...
    <div class="portlet-body">
        <?php $modulo = $sf_params->get('module'); ?>
        <?php echo $form->renderFormTag(url_for($modulo . '/rechazoS?id=' . $id), array('class' => 'form-horizontal"')) ?>
   ...
   <div class="row">
       ...
       <div class="row">
            ...
            <label class="col-md-2 control-label right font-red-sunglo bold Bold  ">Motivo </label>
