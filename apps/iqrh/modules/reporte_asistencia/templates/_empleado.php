...
<?php foreach ($Listado as $regi) { ?>
    ...
    <?php $puntualidad =$regi->getPuntualida(); ?>
        <tr>
            ...
            <td  style="xborder: 1px solid black;" xwidth="70px" align="center" >&nbsp;<font size="-1"><?php //echo $tardes = AsistenciaUsuarioQuery::tardes($inicio, $fin, $regi->getUsuario());  ?>
             <?php   echo $tardes = ProyectoQuery::tardes($regi,$inicio, $fin);  ?>
