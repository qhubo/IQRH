...
abstract class BaseUsuarioPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CODIGO', 'USUARIO', 'CLAVE', 'CORREO', 'ESTADO', 'IMAGEN', 'ADMINISTRADOR', 'VALIDADO', 'ULTIMO_INGRESO', 'TEMA', 'FRASE', 'GENERO', 'FECHA_NACIMIENTO', 'NOMBRE_COMPLETO', 'EMPRESA', 'LOGO', 'ACTIVO', 'TIPO_USUARIO', 'OBSERVACIONES', 'PRIMER_NOMBRE', 'SEGUNDO_NOMBRE', 'PRIMER_APELLIDO', 'SEGUNDO_APELLIDO', 'PUESTO', 'DEPARTAMENTO', 'JEFE', 'FECHA_ALTA', 'SUELDO', 'USUARIO_JEFE', 'ASISTENCIA', 'PUNTUALIDA', 'TOKEN', ),
